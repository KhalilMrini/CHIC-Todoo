...
public class CreateAccountActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    ChildrenDatabaseHelper childrenDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        childrenDb = new ChildrenDatabaseHelper(this);
    }
    ...
    private boolean isEmailValid(String email) {
        ...
        return email.contains("@") && userDb.query(email).getCount() == 0;
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            return userDb.insertData(mEmail, mPassword) && childrenDb.insertData(mEmail, name);
        }
